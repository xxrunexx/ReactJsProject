    ...
    return (
        <div className="col-md-4 mb-5" key={index}>
            <div className="card shadow mb-2" style={{height: "100%"}}>
                <img src={card.url} className="card-img-top mx-auto" alt="Card image cap"/>
            <div className="card-body">
                <p className="card-title">{card.title}</p>
                <p style={{color: "#f05537"}}>{card.event_start}</p>
                <p style={{color: "#39364f"}}>{card.location}</p>
                <p>{card.organizer}</p>
